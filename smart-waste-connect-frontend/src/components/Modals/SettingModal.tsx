...
import { X, Eye, EyeOff, Loader2, Lock, AlertTriangle } from 'lucide-react'
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex gap-3 p-5 pb-0">
          <TabBtn label="Password Settings" active={tab === 'password'} onClick={() => setTab('password')} />
          <TabBtn label="Account Settings" active={tab === 'account'} onClick={() => setTab('account')} />
        </div>
  ...
  return (
    <div className="space-y-4">
      <div className="bg-[#e8f5e9] rounded-xl p-4">
        <h3 className="text-[#2d5a35] font-bold text-base mb-4">Set New Password</h3>

        <PasswordField
          label="Current Password" required
          value={fields.current} show={show.current}
        ...
        <PasswordField
          ...
          value={fields.newPass} show={show.newPass}
        ...
        <PasswordField
          ...
          value={fields.confirm} show={show.confirm}
...
function PasswordField({
  label, value, show, onChange, onToggle, placeholder, required, last = false,
}: {
  label: string; value: string; show: boolean; required?: boolean; last?: boolean
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-xs text-red-400 mt-0.5 leading-relaxed">
              This action is permanent and cannot be undone. All your data, pickup history, and settings will be permanently removed.
            </p>
          </div>
        </div>
