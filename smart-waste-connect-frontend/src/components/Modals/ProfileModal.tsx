...
function Field ({
  ...
  const base =
    'w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-gray-800 focus:outline-none focus:border-[#7FC155] focus:ring-1 focus:ring-[#7FC155] transition-all placeholder:text-gray-400'
  return (
    <div>
